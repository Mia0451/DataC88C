...
class FreeChecking(Account):
    ...
    def __init__(self,account_holder):
        ...
        self.withdraws = FreeChecking.free_withdrawals
    ...
    def withdraw(self, amount):
        ...
        return Account.withdraw(self, amount + self.FreeChecking.withdraw_fee)
...
def duplicate_link(s, val):
    ...
    while current is not Link.empty:
        if current.first == val:
            duplicate = Link(val, current.rest)
            current.rest = duplicate
            current = duplicate.rest
        else:
